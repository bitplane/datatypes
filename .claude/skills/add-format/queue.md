...
| 4 | FTEX | `ftex` | Civilization texture wrapper around DXT1 (`common/bcn.h`) or raw data. Pillow. |
...
| 14 | BLP | `blp` | Blizzard textures. BLP2 uses BC compression from `common/bcn.h`. |
...
| 19 | Arma textures | `paa` | Bohemia Interactive PAA: DXT1–DXT5 and uncompressed variants. |
